...
public class RemoveCommentNotifier extends UseCase<String, Boolean> {
    ...
    public RemoveCommentNotifier(UseCaseExecutor useCaseExecutor, CommentRepository commentRepository) {
        super(useCaseExecutor);
        this.commentRepository = commentRepository;
    }

    @Override
    public ObservableTask<Boolean> createObservableTask(String photoId) {
